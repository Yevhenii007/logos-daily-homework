...
/////////////////////////////////////////////////////////////////////////////////////////
// // Завдання №3
// function getMaxOfArray1(...numbers: number[]): number {
...
/////////////////////////////////////////////////////////////////////////////////////////
// // Завдання №4
// function getSqrt(value: any): void {
// 	if (isNaN(value)) {
...
let arrOfWords = [];
let badWordsSpanElem = arrayElem("span")[1];
let inputElem = firstElem("input");
let textareaElem = firstElem("textarea");
...
cenzor.addEventListener("click", function () {
    ...
    if (!textareaElem.value) {
        ...
        textareaElem.placeholder = "text here..";
        for (let foundWord of arrOfWords) {
            let regExpfoundWord = new RegExp(foundWord, "gi");
            text = text.replace(regExpfoundWord, function () {
                let star = "";
